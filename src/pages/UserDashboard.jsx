  ...
  return (
    <div className="dashboard-page">
      <header className="dashboard-header">
        <a href="/" className="dashboard-logo">MEETFY</a>
        <a href="/login" className="dashboard-logout">Logout</a>
      </header>
      ...
      <div className="dashboard-body">
        <aside className="dashboard-sidebar">
          ...
          <a href="/create-event" className="create-event-btn">＋ Create Event</a>
        </aside>
            ...
            <div className="personalized-grid">
              ...
              <div className="side-recommendations">
                <article className="small-recommendation beige">
                  ...
                  <p>A night of classic soul and jazz in a cozy studio setting with vintage vibes.</p>
                  <a href="/event">View Details</a>
                </article>
                ...
                <article className="small-recommendation pink">
                  ...
                  <p>Build your creative soul with manual hands-on pottery and wheel-throwing.</p>
                  <a href="/event">View Details</a>
                </article>
              </div>
            </div>
